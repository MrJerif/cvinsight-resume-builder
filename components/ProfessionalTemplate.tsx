  ...
  return (
    <div
      ...
      style={{
        zoom: (1 / 794) * width,
        fontFamily:
          "system-ui, -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Oxygen, Ubuntu, Cantarell, 'Open Sans', 'Helvetica Neue', sans-serif", // Modern, clean font
        lineHeight: "1.5",
      }}
      ref={contentRef}
...
function SummarySection({ resumeData }: ResumeSectionProps) {
  ...
  return (
    <div className="space-y-2">
      <p
        className="text-lg font-semibold border-b pb-2 text-gray-800"
        style={{
          color: colorHex,
        }}
      >
