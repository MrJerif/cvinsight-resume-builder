...
export default function FancyTemplate({
  resumeData,
  contentRef,
  containerRef,
  ...
  return (
    <div
      ...
      style={{
        zoom: (1 / 794) * width,
        fontFamily: "Arial, sans-serif", // A widely compatible font
      }}
      ref={contentRef}
...
// Education (Side)
export function EducationSectionSide({ resumeData }: ResumeSectionProps) {
