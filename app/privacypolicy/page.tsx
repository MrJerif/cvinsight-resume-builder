...
const Page = () => {
  return (
    <div className="min-h-screen p-4 md:p-8 bg-white dark:bg-gray-900 text-gray-900 dark:text-gray-100">
      <p className="hidden">
        https://www.termsfeed.com/live/8ba80e12-a10e-4f51-9ccf-9d7950f20672
      </p>
      ...
      <ul>
        ...
        <li>
          <p>
            ...
            this Agreement) refers to CV Insight.
          </p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>
            <strong>Country</strong> refers to: Jammu and Kashmir, India
          </p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>
            <strong>Website</strong> refers to CV Insight, accessible from{" "}
            <a
              href="cvinsight.vercel.app"
              rel="external nofollow noopener"
              target="_blank"
              className="text-blue-500"
            >
              cvinsight.vercel.app
            </a>
          </p>
        </li>
        <li>
      ...
      <h4 className="text-2xl font-semibold">Personal Data</h4>
      <p>
      ...
      <h4 className="text-2xl font-semibold">Usage Data</h4>
      ...
      <h4 className="text-2xl font-semibold">Business Transactions</h4>
      <p>
      ...
      <h4 className="text-2xl font-semibold">Law enforcement</h4>
      <p>
        Under certain circumstances, the Company may be required to disclose
        Your Personal Data if required to do so by law or in response to valid
        requests by public authorities (e.g. a court or a government agency).
      </p>
      <h4 className="text-2xl font-semibold">Other legal requirements</h4>
      <p>
      ...
      <ul>
        <li>By email: cvinsight@gmai.com</li>
      </ul>
