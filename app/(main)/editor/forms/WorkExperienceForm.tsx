...
import { workExperineceSchema, WorkExperineceValues } from "@/lib/validation";
...
export default function WorkExperienceForm({
  ...
  const form = useForm<WorkExperineceValues>({
    resolver: zodResolver(workExperineceSchema),
    defaultValues: {
...
interface WorkExperienceItemProps {
  id: string;
  form: UseFormReturn<WorkExperineceValues>;
  index: number;
